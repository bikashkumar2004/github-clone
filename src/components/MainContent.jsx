...
import { FaCompass, FaMessage } from "react-icons/fa6";
    ...
    <div className="flex-1 min-h-screen pb-[15vh] relative">
      ...
      <div className="max-w-[900px] mx-auto">
        {!showResult ? <><div className="my-12 text-[56px] text-slate-500 font-semibold p-5">
          <p>
            <span className="bg-gradient-to-r from-[#0f15be] to-[#ff5546] bg-clip-text text-transparent">
              Hello, Bikash.
            </span>
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-5">
          ...
          <div className="h-[200px] p-4 bg-gray-200 rounded-lg relative cursor-pointer hover:bg-gray-300">
            <p className="text-slate-700 text-lg">
              Who sits on the the Iron Thrones at the end of the series?
            </p>
            <FaCode className="text-4xl p-1 absolute bottom-2 right-2" />
          </div>
        </div></> : <div className="py-0 px-[5%] max-h-[70vh] overflow-y-scroll scrollbar-hidden">
            ...
            <div className="flex items-start gap-5">
              ...
              {loading ? (
                <div className="w-full flex flex-col gap-2">
                  <hr className="rounded-md border-none bg-gray-200 bg-gradient-to-r from-[#81cafe] via-[#ffffff] to-[#81cafe] p-4 scroll-bg"/>
                  <hr className="rounded-md border-none bg-gray-200 bg-gradient-to-r from-[#81cafe] via-[#ffffff] to-[#81cafe] p-4 scroll-bg"/>
                  <hr className="rounded-md border-none bg-gray-200 bg-gradient-to-r from-[#81cafe] via-[#ffffff] to-[#81cafe] p-4 scroll-bg"/>
                </div> 
              ) : (
        ...
        <div className="absolute bottom-0 w-full max-w-[900px] px-5 mx-auto mt-5">
          <div className="flex items-center justify-between gap-20 bg-gray-200 py-2 px-5 rounded-full">
            ...
            <div className="flex gap-4 items-center ">
              ...
              {input && <IoMdSend onClick={()=>onSent()} className="text-2xl cursor-pointer " />}
            </div>
          </div>
        </div>
      </div>
